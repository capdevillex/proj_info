...
heures de partie — deux bugs ont pourtant déjà été détectés à leur rédaction. Cela confirme
que formaliser les tests est bénéfique dès maintenant, et qu'une couverture plus large reste
un objectif pour les prochaines itérations.
